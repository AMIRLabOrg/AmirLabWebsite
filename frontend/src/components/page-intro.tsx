...
export function PageIntro({
  ...
  return (
    ...
    >
      ...
      {aside ? <aside className="ml-[clamp(1.25rem,3vw,3.4rem)] grid min-w-0 self-stretch border-l border-line pl-[clamp(1.1rem,2.2vw,2.2rem)] max-[900px]:mt-6 max-[900px]:ml-0 max-[900px]:border-t max-[900px]:border-l-0 max-[900px]:pt-4 max-[900px]:pl-0">{aside}</aside> : null}
    </header>
  );
}
