...
export function UniversitiesMarquee({ universities }: { universities: University[] }) {
  ...
  return (
    <div className="group/marquee relative w-full overflow-hidden">
      <span aria-hidden="true" className="pointer-events-none absolute inset-y-0 left-0 z-[1] w-[100px] bg-[linear-gradient(to_right,var(--canvas),transparent)]" />
      <span aria-hidden="true" className="pointer-events-none absolute inset-y-0 right-0 z-[1] w-[100px] bg-[linear-gradient(to_left,var(--canvas),transparent)]" />
