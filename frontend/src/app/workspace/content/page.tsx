...
const PAGES = [
  {
    description:
      "Hero statement, research heading, calls to action, and recruitment band.",
    href: "/workspace/content/home",
    icon: House,
    title: "Home page",
  },
  {
    description:
      "Mission, research focus, organization facts, and closing invitation.",
    href: "/workspace/content/about",
    icon: Info,
    title: "About page",
  },
] as const;
